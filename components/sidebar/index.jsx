...
const sidebarLinks = [
  ...
  { name: "Shortlisted", icon: <Star className="w-auto h-auto monitor:w-8 monitor:h-8" />, href: "/shortlisted" },
    ...
    >
      <div className="flex flex-col gap-4 xl:gap-4 monitor:gap-6 my-2 lg:my-4 hover:items-start pl-1 lg:pl-2 text-supporting-darkGray">
        ...
        >
          ...
          <span className="hidden group-hover:inline text-base ">Download PPT</span>
        </a>
      </div>
    </div>
  );
